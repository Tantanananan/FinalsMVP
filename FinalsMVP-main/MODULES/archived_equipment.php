...
$records_per_page = 10; // Max 10 items per page
...
// FETCH ARCHIVED EQUIPMENT (Paginated for Display)
$query = "SELECT item_id, item_name, serial_Number FROM items $where_clause ORDER BY item_id DESC LIMIT $records_per_page OFFSET $offset";
...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .table th, .table td { white-space: nowrap; padding: 0.75rem 0.5rem !important; }
            .pagination-custom { flex-wrap: wrap; justify-content: center; gap: 0.25rem; }
            .card-footer.d-flex { justify-content: center !important; }
        }
    </style>
</head>
<body>
                                            ...
                                            <tr>
                                                <td colspan="3" class="text-center py-5 text-muted">
                                                    <div class="d-flex flex-column align-items-center">
                                                        ...
                                                        <span>No archived equipment found matching criteria.</span>
                                                    </div>
                                                </td>
                                            </tr>
                                        <?php endif; ?>
