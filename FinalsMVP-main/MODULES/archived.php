...
if (!empty($search)) {
    ...
    $conditions[] = "(first_name LIKE '%$safe_search%' OR last_name LIKE '%$safe_search%')";
}

// If filtering by role
if ($filter !== 'all') {
    $safe_filter = $mysql->real_escape_string($filter);
    $conditions[] = "role = '$safe_filter'";
}

$where_clause = "WHERE " . implode(" AND ", $conditions);

// --- 4. PAGINATION LOGIC START ---
$records_per_page = 10; 
                                            ...
                                            <tr>
                                                <td colspan="4" class="text-center py-5 text-muted">
                                                    <div class="d-flex flex-column align-items-center">
                                                        ...
                                                        <span>No archived users found matching your criteria.</span>
                                                    </div>
                                                </td>
                                            </tr>
                                        <?php endif; ?>
