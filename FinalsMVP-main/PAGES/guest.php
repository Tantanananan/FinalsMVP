...
<head>
    ...
    <style>
        ...
        .pagination-custom .page-item .page-link {
            border: none; color: #6c757d; border-radius: 0.5rem; margin: 0 0.2rem;
        }
    ...
    <div class="hero-section">
        ...
        <div class="container text-center text-lg-start">
            ...
            <p class="hero-subtitle mb-4 fs-5 opacity-90">
                Designed to streamline the management of computer equipment in UCC Congressional MIS.<br>
                By replacing manual logging with a digital interface, it ensures that every hardware asset from <br>
                desktop units to peripheral devices is accounted for in real-time!<br>
            </p>                    
