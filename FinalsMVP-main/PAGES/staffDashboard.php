            ...
            <nav class="main-header navbar navbar-expand navbar-dark border-bottom-0 shadow-sm w-100 m-0">
                <div class="container-fluid">
                    <ul class="navbar-nav align-items-center">
                        ...
                        <li class="nav-item d-none d-sm-inline-block ms-2"><span class="nav-link font-weight-bold text-light p-0" style="font-size: 1.1rem;">Dashboard</span></li>
                    </ul>
                </div>
            </nav>
                ...
                <div class="card border-0 shadow-sm rounded-4 mb-4">
                    ...
                    <div class="card-body p-4">
                        <form id="borrowForm" action="../ACTIONS/process_borrow.php" method="POST" class="row g-3 align-items-end">
                            ...
                            <div class="col-md-3">
                                <label class="form-label fw-bold small text-muted">Borrow Duration</label>
                                <select name="duration_hours" class="form-select custom-input border border-secondary-subtle shadow-sm" required>
    ...
    <?php if (isset($_GET['status'])): ?>
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                <?php elseif ($_GET['status'] == 'invalid_student'): ?>
                    Swal.fire({
                        title: 'Student Not Found',
                        text: 'The Student ID entered does not exist in the database. Please try again.',
                        icon: 'error',
