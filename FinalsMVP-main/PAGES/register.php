...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($isValid) {
        // --- Duplicate Email Check (Since Email is now the Username) ---
    ...
    if ($isValid) {
        ...
        try {
            // Insert into USER table (Using first_name and last_name)
            $sql_user = "INSERT INTO user (username, password, first_name, last_name, role, status, verification_token) VALUES (?, ?, ?, ?, ?, 'Pending', ?)";
            ...
            // Insert into STUDENTS table (Using first_name and last_name)
...
<head>
    ...
    <style>
        ...
        .custom-card-width { max-width: 450px; width: 100%; } /* Widened slightly to fit the two names nicely */
